...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"com.lwk.avro.hello\",\"doc\":\"i am a class\",\"fields\":[{\"name\":\"message\",\"type\":\"string\"}]}");
  ...
  public static com.lwk.avro.hello.Greeting.Builder newBuilder() {
    return new com.lwk.avro.hello.Greeting.Builder();
  }
  
  /** Creates a new Greeting RecordBuilder by copying an existing Builder */
  public static com.lwk.avro.hello.Greeting.Builder newBuilder(com.lwk.avro.hello.Greeting.Builder other) {
    return new com.lwk.avro.hello.Greeting.Builder(other);
  }
  
  /** Creates a new Greeting RecordBuilder by copying an existing Greeting instance */
  public static com.lwk.avro.hello.Greeting.Builder newBuilder(com.lwk.avro.hello.Greeting other) {
    return new com.lwk.avro.hello.Greeting.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
    ...
    private Builder() {
      super(com.lwk.avro.hello.Greeting.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.lwk.avro.hello.Greeting.Builder other) {
      super(other);
    ...
    private Builder(com.lwk.avro.hello.Greeting other) {
            super(com.lwk.avro.hello.Greeting.SCHEMA$);
      if (isValidValue(fields()[0], other.message)) {
        this.message = data().deepCopy(fields()[0].schema(), other.message);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'message' field */
    public com.lwk.avro.hello.Greeting.Builder setMessage(java.lang.CharSequence value) {
    ...
    public com.lwk.avro.hello.Greeting.Builder clearMessage() {
      message = null;
